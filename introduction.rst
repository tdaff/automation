...
it has been designed to automate the process from input of the inital structure
file to generation of isotherms and various other properties by abstracting the
interation between different molecular simulation packages. On a more
...
documentation for details of all the available.
